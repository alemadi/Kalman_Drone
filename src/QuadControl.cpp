...
V3F QuadControl::LateralPositionControl(V3F posCmd, V3F velCmd, V3F pos, V3F vel, V3F accelCmdFF)
{
	...
	////////////////////////////// BEGIN STUDENT CODE ///////////////////////////
	float vel_cmd = sqrtf(velCmd.x*velCmd.x + velCmd.y*velCmd.y);  // calculate the magnitude of the acceleration being commanded

	if (vel_cmd > maxAccelXY) // if the commanded acceleration is too high then reduce
	{
